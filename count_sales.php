...
$sql = "SELECT 
            ...
            SUM(CASE WHEN globe_sales_new = 'No' THEN 1 ELSE 0 END) AS globe_sales_new_no_count,
            SUM(CASE WHEN converge_sales_new = 'Yes' THEN 1 ELSE 0 END) AS converge_sales_new_yes_count,
            SUM(CASE WHEN converge_sales_new = 'No' THEN 1 ELSE 0 END) AS converge_sales_new_no_count,
            SUM(CASE WHEN no_providers_sales_new = 'Yes' THEN 1 ELSE 0 END) AS no_providers_sales_new_yes_count,
            SUM(CASE WHEN no_providers_sales_new = 'No' THEN 1 ELSE 0 END) AS no_providers_sales_new_no_count,
            SUM(CASE WHEN unengaged_sales_new = 'Yes' THEN 1 ELSE 0 END) AS unengaged_sales_new_yes_count,
            SUM(CASE WHEN unengaged_sales_new = 'No' THEN 1 ELSE 0 END) AS unengaged_sales_new_no_count
...
if ($result && $result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . htmlspecialchars($row["pldt_sales_new_yes_count"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["pldt_sales_new_no_count"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["globe_sales_new_yes_count"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["globe_sales_new_no_count"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["converge_sales_new_yes_count"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["converge_sales_new_no_count"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["no_providers_sales_new_yes_count"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["no_providers_sales_new_no_count"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["unengaged_sales_new_yes_count"]) . "</td>";
        echo "<td>" . htmlspecialchars($row["unengaged_sales_new_no_count"]) . "</td>";
        echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
